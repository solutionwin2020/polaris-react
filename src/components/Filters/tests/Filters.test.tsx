...
describe('<Filters />', () => {
  ...
  describe('appliedFilters', () => {
    ...
    it('it renders a clear button when clearButton is not provided', () => {
      const filters = [{ key: 'filterOne', label: 'foo', onRemove: () => { }, filter: null }];
    ...
    it('it doesn\'t renders a clear button when clearButton is not provided', () => {
      const filters = [{ clearButton: false, key: 'filterOne', label: 'foo', onRemove: () => { }, filter: null }];
